"""
This file fetches JSON data of the adoptable pets in Montgomery County_Maryland
from the web and saves it to a local file named data/adoptablepets.json.
"""
...
def main():
    ...
    fetch_json_file(fetched_folder_name, "adoptablepets.json", json_url)
