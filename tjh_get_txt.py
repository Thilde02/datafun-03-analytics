...
and saves it to a local file named midsummer.txt in a folder named data.
...
def main():
    ...
    """
    txt_url = 'https://github.com/benschw/shakespeare-txt/blob/master/shakespeare-midsummer-16.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(fetched_folder_name, "midsummer.txt", txt_url)
