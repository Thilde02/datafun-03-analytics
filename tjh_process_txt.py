"""
Process a text file to count the times of the word "Dream" in  A Midsummer Night’s Dream
"""
...
def process_text_file():
    """Read a text file, count occurrences of 'Dream', and save the result."""
    input_file = pathlib.Path(fetched_folder_name, "midsummer.txt")
    output_file = pathlib.Path(processed_folder_name, "text_dream_word_count.txt")
    word_to_count: str = "Dream"
