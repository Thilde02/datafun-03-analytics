...
and saves it to a local file named avgelectricprice_annual.xlsx in a folder named data.
"""
#####################################
...
def main():
    ...
    fetch_excel_file(fetched_folder_name, "avgelectricprice_annual.xlsx", excel_url)
